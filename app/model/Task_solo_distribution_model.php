...
class Task_solo_distribution_model{
    ...
    public function getAllTask(){
        $this->db->query("SELECT * FROM " . $this->table ." JOIN task_solo ON ".$this->table.".id_task = task_solo.id JOIN mapel ON task_solo.id_mapel = mapel.id  WHERE id_profile = ". $_SESSION['id'] . " ORDER BY task_solo.tgl_dibuat ASC" );
