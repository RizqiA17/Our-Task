...
class Task_group_model
{
    ...
    {
        $this->db->query("SELECT " . $this->table . ".id, name, tgl_deadline, tgl_dibuat, grade FROM " . $this->table . " JOIN mapel ON " . $this->table . ".id_mapel = mapel.id JOIN kelas ON " . $this->table . ".id_kelas = kelas.id WHERE id_guru = :id");
    ...
    {
        $this->db->query("SELECT * FROM " . $this->table . " " . $this->table . " JOIN mapel ON " . $this->table . ".id_mapel = mapel.id JOIN kelas ON " . $this->table . ".id_kelas = kelas.id WHERE " . $this->table . ".id = " . $id);
