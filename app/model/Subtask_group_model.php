...
class Subtask_group_model
{
    ...
    {
        $this->db->query("INSERT INTO " . $this->table . " (id, name, description, description_file, deadline, id_task, id_leader) VALUES (null, '" . $title . "', '" . $detail . "', '" . $filename . "', '" . $deadline . "', " . $id_task . ", " . $_SESSION['id'] . ")");
        $this->db->execute();
