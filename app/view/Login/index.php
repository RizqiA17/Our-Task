...
<body class=" flex items-center bg-50 dark:bg-800 dark:text-50 flex-col justify-center h-svh w-screen">
    <div class=" max-[559px]:w-full max-[559px]:px-14">
            ...
            <form class="w-full flex flex-col items-center" action="<?= BASEURL ?>/login/signin" method="post">
                ...
                <div class=" dark:bg-700  flex mt-5 border-solid border border-200 dark:border-500 rounded-xl h-12 w-full max-md:h-11">
                    ...
                    <div class=" flex-grow flex items-center justify-between gap-1 bg-inherit outline-none pl-7 max-md:pl-2.5 flex-grow pr-3 max-md:pr-2.5 rounded-r-xl max-md:text-sm">
                        <input type="password" id="password" placeholder="Password" required name='password' class=" md:mr-3 max-md:text-sm bg-inherit w-full outline-none">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="white" class="material-symbols-outlined" id="toggleIcon">
                ...
                <a href="" class="font-semibold font-Poppins text-sm self-end right-0 mt-3 text-base-500 hover:text-base-600 active:text-400 max-md:text-xs">Forgot password?</a>
        ...
        <label for="" class="mt-5 w-full flex items-center justify-center gap-2 max-md:text-xs">Don't have an account? <a href="<?=BASEURL?>login/signup" class="font-semibold font-Poppins text-sm text-base-500 hover:text-base-600 max-md:text-xs">Sign Up</a></label>
    </div>
    <script>
