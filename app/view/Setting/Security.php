...
<body class="bg-base-500 dark:bg-600 dark:text-50 h-[calc(100svh_-_120px)]">
    ...
    <div class="bg-white dark:bg-800 w-full h-full mt-14 pt-10 rounded-t-3xl">
        ...
        <div class="px-7 py-10 ">
            ...
            <br>
            Change Password
            <form action="<?= BASEURL ?>setting/changePassword" method="post">
                <div class="mt-4">
                    <label class="pt-10 text-[#006EE9] font-medium " for="">Password</label>
                    <input type="password" name="email" id="email" class="mt-1 flex border-2 dark:bg-700 border-[#bdd3ec] rounded-lg w-[100%] px-4 py-3 text-sm " placeholder="Password Now">
                </div>
                <div class="mt-4">
                    <label class="pt-10 text-[#006EE9] font-medium " for="">Password</label>
                    <input type="password" name="password" id="password" c class="mt-1 flex border-2 dark:bg-700 border-[#bdd3ec] rounded-lg w-[100%] px-4 py-3 text-sm " placeholder="New Password">
                </div>
